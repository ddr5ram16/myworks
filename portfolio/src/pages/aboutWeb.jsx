            ...
            <div id="nav_burger">
                <nav>
                    <ul>
                        ...
                        <li><NavLink to="/">Self-Promotion</NavLink></li>
                    ...
                    <div className="work_detail_item">
                        <div className="text">
                            <dl>
                                ...
                                <dt>制作期間</dt>
                                <dd>
                                    <span className="work_align">{about.designTime}</span>
                                    <span className="work_align">{about.codeTime}</span>
                                </dd>
                                <dt>素材について</dt>
                                <dd>主にAdobe fire flyを使用して生成、およびフリー素材を使用</dd>
                                <dt>使用ソフト</dt>
                                <dd>
                                    <span className="work_align">{about.desing}</span>
                                    <span className="work_align">{about.code}</span>
                                </dd>
                                <dt>サイトカラー</dt>
                                <dd>
